...
import people.songpagu.goodgame.application.member.auth.join.outgoing.MockMemberFindPort
...
internal class MemberJoinServiceUnitTest : BehaviorSpec({
    ...
    given("이미 회원가입이 되어 있으면") {
        ...
        val memberFindPort = object : MockMemberFindPort() {
    ...
    companion object {
        val DO_NOT_THING_FIND_PORT: MemberFindPort = MockMemberFindPort()
